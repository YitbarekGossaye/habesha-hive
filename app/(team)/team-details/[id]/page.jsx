...
export const metadata = {
  title: "Team Details || Habesha Hive - Expert Web Solutions Team",
  description:
    "Meet the talented team behind Habesha Hive's cutting-edge web solutions and digital expertise.",
};
