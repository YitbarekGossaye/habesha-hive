...
export const metadata = {
  title: "Service Details || Habesha Hive - Expert Web Solutions",
  description:
    "Explore detailed insights into Habesha Hive's specialized web solutions designed to meet diverse digital needs.",
};
