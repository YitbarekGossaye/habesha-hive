          ...
          <div className="container">
            <div className="about-wrapper style2">
              <div
                ...
                data-wow-delay=".6s"
              >
                <div className="about-thumb-box about-thumb1 mt-60">
                  <Image
                    alt="thumb"
              ...
              >
                <div className="title-area">
                  ...
                  <h2 className="title text-start">
                    Delivering Innovative Web Solutions for Your Success
                  </h2>
                  <p className="text">
                    At Habesha Hive, we are dedicated to transforming your
                    digital presence with tailored web solutions. Our team of
                    experts combines creativity and technology to empower your
                    business, ensuring a seamless and engaging online experience
                    for your clients.
                  </p>
                </div>
